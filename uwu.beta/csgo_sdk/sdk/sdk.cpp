...
namespace Interfaces
{
    ...
    void Initialize()
    {
        ...
        g_EngineVGui          = get_interface<IEngineVGUI>         (engineFactory   , "VEngineVGui001");
        g_Memory = *reinterpret_cast<IMemAlloc**> (GetProcAddress(GetModuleHandleA("tier0.dll"), "g_pMemAlloc"));

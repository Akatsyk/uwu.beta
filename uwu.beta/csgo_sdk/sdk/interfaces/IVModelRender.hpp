...
template<typename T>
__forceinline T GetViFunct(void* base, int index) { return (*static_cast<T**>(base))[index]; }

#define VFUNCTION(func, index, type, ...) auto func { return GetViFunct<type>(this, index)(this, __VA_ARGS__); };

class IMemAlloc {
public:
    VFUNCTION(alloc(size_t size), 1, void* (__thiscall*)(void*, size_t), size)
    VFUNCTION(realloc(void* mem, size_t size), 3, void* (__thiscall*)(void*, void*, size_t), mem, size)
    VFUNCTION(free(void* mem), 5, void(__thiscall*)(void*, void*), mem)
};

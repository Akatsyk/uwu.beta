...
// RayTracer provides the same functionality as ClipRayToEntity, only it allows to trace for a specific hitbox through all others and provides 
// exceptional performance compared to the game's RayTracing engine due to its inherent specialization.
